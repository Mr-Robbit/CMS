...
<table class="table table-bordered">
    ...
    <?php
        ...
        while( $list_all_posts = mysqli_fetch_assoc($query_all_posts )){
            ...
            $comment_title = $list_all_comments['comment_title'];
            $comment_category_id = $list_all_comments['comment_category_id'];
            $comment_status = $list_all_comments['comment_status'];
            $comment_image = $list_all_comments['comment_image'];
            $comment_tags = $list_all_comments['comment_tag'];
            $comment_comment_count = $list_all_comments['comment_comment_count'];
