    ...
    <?php
        ...
        echo "<tr id='row{$list_all_posts['post_id']}' >";
            ...
            <td class='editTR edittable'>
                <a class="cPreview" href="posts.php?source=edit_post&p_id=echo $list_all_posts['post_id']">
            ...
            echo "<td class='deleteTR edittable delete_btn' ><a class='delbtn' href='posts.php?delete={$list_all_posts['post_id']}'>Delete</a></td>";
            echo "</tr>";
        }
